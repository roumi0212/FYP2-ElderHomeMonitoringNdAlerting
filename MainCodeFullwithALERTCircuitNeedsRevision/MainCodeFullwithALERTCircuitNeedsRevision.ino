...
// User alert button pin
// const int alertButtonPin = 16; // GPIO pin connected to the user alert button

// Stop alert button pin
...
void loop() {
  ...
  // int alertButtonState = digitalRead(alertButtonPin);
  // if (alertButtonState == LOW) { // Assuming LOW means the button is pressed
  //   alertUser();
  // }
...
void monitorBathroom() {
  ...
  if (rainValue < 3000) { // Adjust threshold as needed
    rainAlert = 1;
